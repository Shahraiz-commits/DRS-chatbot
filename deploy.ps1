...
Write-Output "Building and pushing Rasa Chatbot image..."
...
Write-Output "Building and pushing Action Server image..."
...
Write-Output "Building and pushing Frontend image..."
...
Write-Output "Deploying Rasa Chatbot to Cloud Run..."
...
Write-Output "Deploying Action Server to Cloud Run..."
...
Write-Output "Clearing cached containers..."
